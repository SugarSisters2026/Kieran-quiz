...
const QUESTIONS = [
  // ---------- WEEK 1 ----------
  { d: 1, week: 1,
    followup: { a: "The folio charge is not evidence of an absolute assignment of the debt.", q: "Which paragraph of Fannon says the register is not evidence of the terms of the assignment?" },
  ...
  { d: 2, week: 1,
    followup: { a: "Absolute, in writing signed by the assignor, of a debt or chose in action, express written notice to the debtor.", q: "Which of the four is the one Pepper is most likely to fail here, and why?" },
  ...
  { d: 3, week: 1,
    followup: { a: "Either Pepper proves an absolute assignment of the debt and sues alone, or it does not and the owner of the debt must be before the court.", q: "Name the case that says a bare legal title holder CAN sue, which is their answer to you." },
    q: "Standing in this courtroom, what is the practical difference between a legal assignee and an equitable assignee? Put your answer as a fork: either Pepper proves one thing, or it does not, and say what follows in each case.",
    focus: "Do NOT say Pepper must hold both legal and beneficial title. That is wrong and counsel will correct you. A bare legal title holder CAN sue. The question is whether it can prove the assignment.",
    covers: [
      "The statute is section 28(6) of the Supreme Court of Judicature Act (Ireland) 1877. Get the name right",
      "Either Pepper satisfies all four conditions on the debt, in which case it sues in its own name alone and it does not matter where the beneficial interest sits",
      "Or it does not, in which case it is at best an equitable assignee and whoever owns the debt has to be before the court",
      "Do not argue that the beneficial owner must be joined in every case. Pepper Finance v Jenkins [2018] IEHC 485 says a bare legal title holder can enforce for the beneficial owner, and that is their answer",
      "The finishing sentence, and it is the whole point: both roads end in the same place, because nothing before the court shows which road we are on",
      "For Doyle specifically: the Form 56 registration under section 64 moved the charge. The PRA letter says nothing about the debt. So Pepper is a registered charge owner with no proved assignment of the chose in action"
    ]},
  { d: 4, week: 1,
    followup: { a: "Deutsche Trustee took the debt in April 2014; Pepper holds legal title only, nominated by the buyer.", q: "Which of those seven is in liquidation, and why does that matter?" },
  ...
  { d: 5, week: 1,
    followup: { a: "14 April 2014, fifteen months before the Civil Bill of 22 July 2015.", q: "What did Tanager assign away on that date, in six words?" },
  ...
  { d: 6, week: 1,
    followup: { a: "Because it is their own public filing, not your allegation.", q: "What exactly does the C1 say was assigned?" },
  ...
  { d: 7, week: 1,
    followup: { a: "Plain language, no citations, ninety seconds.", q: "Which single sentence in your ninety seconds does the most work?" },
  ...
  // ---------- WEEK 2 ----------
  { d: 8, week: 2,
    followup: { a: "Standing goes to the court's power to grant the relief at all.", q: "Who is the judge in Cahill v Sutton and what year?" },
  ...
  { d: 9, week: 2,
    followup: { a: "Goold v Collins: jurisdiction may be raised at any stage.", q: "What is the second, stronger reason it can be raised now?" },
  ...
  { d: 10, week: 2,
    followup: { a: "Order 27 January 2020, transfer 25 March 2021, joinder 7 February 2022.", q: "Which of those three dates does the most damage to Pepper?" },
  ...
  { d: 11, week: 2,
    followup: { a: "The Global Deed names Pepper but gives CRO 649497, which is a different company.", q: "What is the honest limit of that point?" },
  ...
  { d: 12, week: 2,
    followup: { a: "Clause 7.2 of the April 2014 Deed of Charge: no disposal without the Security Trustee's written consent.", q: "What do you ask the court to do about it, rather than assert?" },
  ...
  { d: 13, week: 2,
    followup: { a: "Threshold matter, jurisdictional, cannot be waived, before evidence is called.", q: "Say the second sentence of it now, without looking." },
  ...
  { d: 14, week: 2,
    followup: { a: "Pepper was not a party, its title is later and unproven, and a court cannot give possession to a party that cannot prove entitlement.", q: "Which of your three sentences would you drop if the judge stopped you at two?" },
  ...
  // ---------- WEEK 3 ----------
  { d: 15, week: 3,
    followup: { a: "They confirm Lagado is an SPV and that SPV registration is not authorisation. They do not allege anyone acted unlawfully.", q: "What did the Central Bank expressly decline to do in those letters?" },
  ...
  { d: 16, week: 3,
    followup: { a: "The debtor lost. The appeal was dismissed.", q: "What threshold did he fail to meet, in Hogan J's own words?" },
  ...
  { d: 17, week: 3,
    followup: { a: "A Central Bank public notice, and the Supreme Court held it was not enough.", q: "So how do you use the Lagado material, if not as an illegality defence?" },
  ...
  { d: 18, week: 3,
    followup: { a: "Because this is a de novo rehearing, not an appeal, so nothing is new.", q: "What is the statutory provision that makes it a rehearing?" },
  ...
  { d: 19, week: 3,
    followup: { a: "At the permissive end, because Pepper's joinder is a supervening fact.", q: "What does supervening mean here, in one sentence?" },
  ...
  { d: 20, week: 3,
    followup: { a: "Paying whoever tells you to pay is not an admission of their title.", q: "Which 2025 Court of Appeal case says prior dealings do not preclude a standing challenge?" },
  ...
  { d: 21, week: 3,
    followup: { a: "This is a rehearing, and the point could not be raised against a party who was not there.", q: "How many sentences do you spend on the solicitor history? Say the number." },
  ...
  // ---------- WEEK 4 ----------
  { d: 22, week: 4,
    followup: { a: "Parallel High Court proceedings reasonably offering a chance of a substantive remedy.", q: "Do you have to show the plenary will succeed? Yes or no, and why?" },
  ...
  { d: 23, week: 4,
    followup: { a: "Tanager, Bank of Scotland plc, Deutsche Trustee, Tailte Eireann and the Attorney General.", q: "What does the plenary actually ask the court to decide?" },
  ...
  { d: 24, week: 4,
    followup: { a: "If the 2021 transfer is invalid, Pepper has no title to enforce.", q: "What is the second, separate route by which the plenary could remove the basis for the order?" },
  ...
  { d: 25, week: 4,
    followup: { a: "Bring whatever happened on 12 October to court, stated accurately.", q: "What do you say if nothing at all happened on 12 October?" },
  ...
  { d: 26, week: 4,
    followup: { a: "Say plainly what happened. The standing and unfair terms arguments survive without the plenary.", q: "Why does the standing point survive independently?" },
  ...
  { d: 27, week: 4,
    followup: { a: "Standing, then adjournment, then unfair terms.", q: "Why does standing go first rather than last?" },
  ...
  { d: 28, week: 4,
    followup: { a: "Record number, the Cuffe test, the link to this claim, then sit down.", q: "What is the one thing you must not do after you finish?" },
  ...
  // ---------- WEEK 5 ----------
  { d: 29, week: 5,
    followup: { a: "3.3 rate variation, 5.2(d) arrears interest, 7.4 conclusive evidence, 8.1 assignment.", q: "Which of the four is the weakest, and what do you do about that?" },
  ...
  { d: 30, week: 5,
    followup: { a: "The APR asterisk points to the ECB rate; clause 3.3 contains no ECB reference at all.", q: "What were the two rates on the day of the offer, and why does that matter?" },
  ...
  { d: 31, week: 5,
    followup: { a: "Charging the full mortgage rate on arrears is a disproportionate burden.", q: "Which paragraph of Banco Primus, and what is the 2026 CJEU case number?" },
  ...
  { d: 32, week: 5,
    followup: { a: "It makes the lender's own certificate final as to what is owed.", q: "Why is that a problem when the arrears figure has already been adjusted once?" },
  ...
  { d: 33, week: 5,
    followup: { a: "The consumer consented in advance to an unknown future party varying the rate.", q: "How much of your time should this one get?" },
  ...
  { d: 34, week: 5,
    followup: { a: "The court must assess unfair terms of its own motion, as a matter of public policy.", q: "Which paragraph of Cannon, and which judge?" },
  ...
  { d: 35, week: 5,
    followup: { a: "Possession follows from a valid demand for a sum properly due.", q: "Which case refused possession because the contractual documents were not before the court?" },
  ...
  // ---------- WEEK 6 ----------
  { d: 36, week: 6,
    followup: { a: "In Cannon the rate moved in the borrowers' favour. Here it did not, and clause 3.3 has no criteria at all.", q: "What is Cannon still good for, on your side?" },
  ...
  { d: 37, week: 6,
    followup: { a: "Possession was remitted to plenary on consumer law grounds.", q: "What do you use O'Reilly to answer?" },
  ...
  { d: 38, week: 6,
    followup: { a: "Wolfhound, the 2014 assignment, the Purchase Deed, repurchase conditionality, arrears and hearsay.", q: "What is the one sentence you say about Brendan's submissions before moving on?" },
  ...
  { d: 39, week: 6,
    followup: { a: "Two sentences, factual, no adjectives, then back to the law.", q: "What is the sentence you say immediately after those two?" },
  ...
  { d: 40, week: 6,
    followup: { a: "Rehearing, servicer's own representations, three defined arguments plus a live plenary.", q: "Which of the three questions is hardest for you, honestly?" },
  ...
  { d: 41, week: 6,
    followup: { a: "Opening words, standing, adjournment, unfair terms.", q: "Where did you hesitate? Name the exact point." },
  ...
  { d: 42, week: 6,
    followup: { a: "Standing application, verbatim, first.", q: "What do you do if you lose your place?" },
  ...
  { d: 43, week: 7, drill: true,
    followup: { a: "The register proves who is registered. It proves nothing about who owns the debt.", q: "Which paragraph of Fannon, and what does it say section 31 is NOT evidence of?" },
  ...
  { d: 44, week: 7, drill: true,
    followup: { a: "He argued BOS could not transfer without being registered, and lost under section 90.", q: "Which paragraph of Kane held the 14 April 2014 deed effective?" },
  ...
  { d: 45, week: 7, drill: true,
    followup: { a: "That the right to seek possession has arisen and is exercisable on the facts.", q: "Which paragraph of Cody sets out the two facts?" },
  ...
  { d: 46, week: 7, drill: true,
    followup: { a: "Both. The sum is disputed and so is their entitlement.", q: "What happens if you only answer one half?" },
  ...
  { d: 47, week: 7, drill: true,
    followup: { a: "Answer it directly, then return to the sum being disputed.", q: "What is worse than a modest figure here?" },
  ...
  { d: 48, week: 7, drill: true,
    followup: { a: "Possession of a family home is not readily undone once executed.", q: "What is the prejudice to them, and why is it different?" },
  ...
  { d: 49, week: 7, drill: true,
    followup: { a: "Decide it before the day, not standing up.", q: "What is your actual answer? Say yes or no now." },
  ...
  { d: 50, week: 7, drill: true,
    followup: { a: "Agree with them. The illegality point is not run as a freestanding defence.", q: "What did Cave actually turn on, in one word?" },
  ...
  { d: 51, week: 7, drill: true,
    followup: { a: "Kane paragraph 87 gives this court inherent jurisdiction to adjourn pending other proceedings.", q: "When must the adjournment application be made, and which paragraph of Cody says so?" },
  ...
  { d: 52, week: 7, drill: true,
    followup: { a: "I adopt Mr Donlon's submissions and will not repeat them.", q: "Name the three things that are yours alone." },
  ...
  { d: 53, week: 7, drill: true,
    followup: { a: "This is a rehearing, and the standing point could not be made against a party who was not there.", q: "How long do you spend on the solicitor history?" },
  ...
  { d: 54, week: 7, drill: true,
    followup: { a: "A certificate on a point of exceptional public importance.", q: "Is there an appeal as of right? Yes or no." },
  ...
  { d: 55, week: 7, drill: true,
    followup: { a: "A stay, time in the property, and costs reserved.", q: "Where is that written down?" },
  ...
  { d: 56, week: 7, drill: true,
    followup: { a: "Stop talking, mid sentence if necessary, and move to the next heading.", q: "What does 'I have that point' usually mean?" },
  ...
  { d: 57, week: 7, drill: true,
    followup: { a: "Opening words, standing, adjournment, unfair terms, answering every interruption.", q: "What is the one thing still shaky, and what are you going to do about it tonight?" },
